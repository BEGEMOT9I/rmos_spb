...
class Calendar extends Component {
  ...
  changeYear(delta) {
    ...
    if (next_date.getFullYear() < this.firstDay.getFullYear() || next_date.getFullYear() > this.lastDay.getFullYear()) {
      return
    }
  ...
  changeMonth(delta) {
    ...
    if (next_date.getMonth() < this.firstDay.getMonth() && next_date.getFullYear() <= this.firstDay.getFullYear() || next_date.getMonth() > this.lastDay.getMonth() && next_date.getFullYear() >= this.lastDay.getFullYear()) {
      return
    }
    ...
    return (
      <div className="page-template__block calendar">
        ...
        <nav className="calendar__nav">
          ...
          <span className="nav__title">{ this.props.selectedMonth } { this.props.selectedYear }</span>
